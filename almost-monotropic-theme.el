...
(let ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((t (:foreground ,fg :weight semi-bold :height 1))))
   `(org-level-2 ((t (:foreground ,fg :weight semi-bold :height 1))))
   `(org-level-3 ((t (:foreground ,fg :weight semi-bold :height 1))))
   `(org-level-4 ((t (:foreground ,fg :weight semi-bold :height 1))))
   `(org-level-5 ((t (:foreground ,fg :weight semi-bold :height 1))))
   `(org-level-6 ((t (:foreground ,fg :weight semi-bold :height 1))))
