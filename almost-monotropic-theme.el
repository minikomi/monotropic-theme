...
(let ((fg "#ff1111")
  ...
  (custom-theme-set-faces
   ...
   `(modeline ((t (:background ,bg :foreground ,fg :height ))))
   ...
   `(org-level-2 ((t (:foreground ,fg :weight semi-bold))))
   `(org-level-3 ((t (:foreground ,fg :weight semi-bold))))
   `(org-level-4 ((t (:foreground ,fg :weight semi-bold))))
   `(org-level-5 ((t (:foreground ,fg :weight semi-bold))))
   `(org-level-6 ((t (:foreground ,fg :weight semi-bold))))
   ...
   `(dired-subtree-depth-1-face ((t (:foreground ,fg))))
   `(dired-subtree-depth-2-face ((t (:foreground ,fg))))
   `(dired-subtree-depth-3-face ((t (:foreground ,fg))))
   `(dired-subtree-depth-4-face ((t (:foreground ,fg))))
